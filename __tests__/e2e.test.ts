...
import jstmPresetDefault from '@jstm/preset-default';
...
const integrationFixtureDir = path.join(__dirname, '__fixtures__', 'e2e');
...
test('basic', async () => {
  ...
  await jstmPresetDefault.apply(projectPath);
